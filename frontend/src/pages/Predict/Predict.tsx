...
const ConfirmWager = ({ UserAnswer, coins }) => (
    <div className="bg-blue-50 border-2 border-blue-500 shadow-sm flex flex-row justify-between rounded-2xl p-4 space-x-6">
        <div className="flex flex-col">
            <p className="text-sm">You answered: <strong>{UserAnswer}</strong></p>
            <span className="flex flex-row space-x-1 pt-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#D4AF37" className="bi bi-coin" viewBox="0 0 16 16">
